    ...
    public static class Configuration
    {
        ...
        public static readonly Dictionary<string, List<string>> ExpectedDropdownOptions = new()
        {
            { "Dropdown-1", new List<string> {
                ...
                "DataDirect – Secure Data Connectivity & Integration",
                "Flowmon – Network Performance and Security",
                "Kemp LoadMaster – Load Balancing",
                "Kendo UI & Telerik – UI/UX Tools",
                "MarkLogic Data Platform – Solve Complex Data Challenges",
                "MOVEit – Secure File Transfer",
                "OpenEdge – Mission Critical App Platform",
                "Podio – Project Management & Collaboration",
                "Semaphore – Smarter Decisions Powered by Metadata",
                "ShareFile – Document Sharing and Storage",
                "Sitefinity – Content Management and Digital Experience Platform",
                "ThemeBuilder – The Powerful Telerik and Kendo UI Styles Builder",
                "WhatsUp Gold – IT Infrastructure Monitoring",
                "WS_FTP – Secure FTP Server" } },
            { "Dropdown-2", new List<string> {
                "Select company type",
                "Independent Software Vendor",
                "Corporation or Government Entity",
                "Technology System Integrator or Consultancy",
                "Progress Partner",
                "Software Reseller",
